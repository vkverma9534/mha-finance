...
def find_annaul_estimations(symbol: str, decay_parameter: float | None = None, lookback: int | None = None) -> np.ndarray:
    ...
    price_instances = [
        realized_price_proxy_at(time=t, df=annual_data_fetch)
