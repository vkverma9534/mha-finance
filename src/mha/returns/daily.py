...
def find_daily_estimations(symbol: str, decay_parameter: float| None = None, lookback: int | None = None) -> np.ndarray:
    ...
    price_instances = [
        realized_price_proxy_at(time=t, df=daily_data_fetch)
